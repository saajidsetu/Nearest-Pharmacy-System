...
namespace HirePurchase
{
    class DatabaseAccess
    {
        ...
        public DatabaseAccess()
        {
            ...
            //  connTable.Add("ConnDB230", "server=shahadul-pc;database=Bacsdb;uid=shahadul;Password=123321;");
            // connTable.Add("ConnDB230", "Data Source=SHAHADUL-PC;Initial Catalog=BacsDB;User ID=shahadul;Password=Aa123456;");
